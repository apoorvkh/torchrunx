...
uv run python -c "from argparse import ArgumentParser; from torchrunx.integrations.cli import add_torchrunx_argument_group; parser = ArgumentParser(); add_torchrunx_argument_group(parser); parser.parse_args()" --help > docs/source/artifacts/argparse_cli_help.txt
